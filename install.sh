...
run_silent "Configuring" "wget -q https://raw.githubusercontent.com/Beni-glith/ZiVPN1/main/config.json -O /etc/zivpn/config.json"
...
run_silent "Setting up API" "wget -q https://raw.githubusercontent.com/Beni-glith/ZiVPN1/main/zivpn-api.go -O /etc/zivpn/api/zivpn-api.go && wget -q https://raw.githubusercontent.com/Beni-glith/ZiVPN1/main/go.mod -O /etc/zivpn/api/go.mod"
